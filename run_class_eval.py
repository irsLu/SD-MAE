...
from engine_for_finetuning import evaluateEx
import utils
...
def main(args, ds_init):
    ...
    if args.finetune:
        ...
        print("Load ckpt from %s" % args.finetune, checkpoint["epoch"])
    ...
    if args.eval:
        test_stats = evaluateEx(data_loader_val, model, device, args)
